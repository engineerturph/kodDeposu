...
void trapezYontemi(){
    float arrElements[3][MAX_EL]={{0},{0},{0}},h,sonuc=0.0,baslangic,bitis,i,parca;
...
void sayisalTurev(){
    int turevTuru;
    float arrElements[3][MAX_EL]={{0},{0},{0}},h,sonuc,x0;
    fonksiyonAl(arrElements);
...
void newtonRaphsonMethod(){
    float arrElements[3][MAX_EL]={{0},{0},{0}};
    fonksiyonAl(arrElements);
    ...
    float arrElementsTurev[3][MAX_EL]={{0},{0},{0}},fturevx1;
...
void arrElcopy (void * destmat, void * srcmat)
{
    memcpy(destmat,srcmat, 3*MAX_EL*sizeof(int));
}
void turevAl(float elements[3][MAX_EL]){
    int i;
    for(i=0;i<MAX_EL;i++){
        if(elements[2][i]==0) {
...
float sonucuHesapla(float arrElements[3][MAX_EL],float x)
{
...
void elementBol(char elements[][MAX_LENGTH],float arrElements[3][MAX_EL]){
    ...
    while(elements[i][0]!=0) {
        ...
        printf("%d.eleman=%f %d.us=%f %d.Tur=%f\n",i+1,arrElements[0][i],i+1,arrElements[1][i],i+1,arrElements[2][i]);
        i++;
    }
}
